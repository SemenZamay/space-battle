...
YELLOW_SPACESHIP = pygame.image.load(os.path.join('Assets', 'spaceship_yellow1.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 270)

RED_SPACESHIP = pygame.image.load(os.path.join('Assets', 'spaceship_red2.png'))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 0)
